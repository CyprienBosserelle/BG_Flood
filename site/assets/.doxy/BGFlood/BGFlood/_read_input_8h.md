...
[**FileList**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**ReadInput.h**](_read_input_8h.md)

[Go to the source code of this file](_read_input_8h_source.md)
...
| Type | Name |
| ---: | :--- |
|  void | [**InitialiseToutput**](#function-initialisetoutput) ([**T\_output**](class_t__output.md) & Toutput, [**Param**](class_param.md) XParam) <br>_Initialise the Toutput structure with output times. This function reads the output times from a specified input string and ensures that the times are within the simulation time range. If no valid times are provided, it defaults to using the total time and end time._  |
