...
[**FileList**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**Write\_txtlog.cpp**](_write__txtlog_8cpp.md)

[Go to the source code of this file](_write__txtlog_8cpp_source.md)
...
| Type | Name |
| ---: | :--- |
|  void | [**SaveParamtolog**](#function-saveparamtolog) ([**Param**](class_param.md) XParam) <br>_Save model parameters to the log file. Saves the model parameters from the given_ [_**Param**_](class_param.md) _object to the log file "BG\_log.txt"._ |
...
|  void | [**saveparam2netCDF**](#function-saveparam2netcdf) (int ncid, int bgfid, [**Param**](class_param.md) XParam) <br>_Save model parameters to a NetCDF file. Saves the model parameters from the given_ [_**Param**_](class_param.md) _object to a NetCDF file._ |
...
_Save model parameters to the log file. Saves the model parameters from the given_ [_**Param**_](class_param.md) _object to the log file "BG\_log.txt"._
```C++
void SaveParamtolog (
    Param XParam
) 
...
* `XParam` The [**Param**](class_param.md) object containing the model parameters 
...
_Save model parameters to a NetCDF file. Saves the model parameters from the given_ [_**Param**_](class_param.md) _object to a NetCDF file._
```C++
