...
Here, the bathymetry map resolution is a 10m resolution ( $ 𝑑𝑥_0=10𝑚$). We will impose\+:
\begin{DoxyItemize}
\item a level -\/3 resolution ( $𝑑𝑥_{−3}=80𝑚$) in the background domain,
\item a level 1 resolution ( $𝑑𝑥_1=5𝑚$) in the flooded area
\item a level 2 resolution ( $𝑑𝑥_2=2.5𝑚$) in the main river bed area.
\end{DoxyItemize}
