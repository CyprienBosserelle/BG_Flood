...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{Manual_autotoc_md104}{}\doxysection{Model controls}\label{Manual_autotoc_md104}
...
By default this instruction file is called {\ttfamily BG\+\_\+param.\+txt}.\hypertarget{Manual_autotoc_md105}{}\doxysubsection{BG\+\_\+param.\+txt}\label{Manual_autotoc_md105}
All the model inputs are controlled by the {\ttfamily BG\+\_\+param.\+txt} file. It is a simple text file that contains the parameters of the model that the user wishes to change. While it is easy to build such file manually but also it is easy to use script and/or programming language to generate and modify text file to automatically to build and run many simulations.\hypertarget{Manual_autotoc_md106}{}\doxysubsubsection{How to use the BG\+\_\+param.\+txt file}\label{Manual_autotoc_md106}
...
\mbox{\hyperlink{ParameterList}{Full list of the parameters}}\hypertarget{Manual_autotoc_md109}{}\doxysubsection{Bathymetry/topography files}\label{Manual_autotoc_md109}
...
\end{DoxyCode}
\hypertarget{Manual_autotoc_md113}{}\doxysubsubsection{Boundary file (for type 2 or 3)}\label{Manual_autotoc_md113}
Water level boundary file are needed to type 2 and 3 boundaries. The files are 2 (or more) columns, one with time in the first column and water level is the other(s). Note that the time step in the file doesn\textquotesingle{}t need to be constant. The model will linearly interpolated between steps in the file. The file can be either comma separated or tab separated. This is automatically detected.\hypertarget{Manual_autotoc_md114}{}\doxyparagraph{Uniform boundary file}\label{Manual_autotoc_md114}
...
\end{DoxyCode}
\hypertarget{Manual_autotoc_md115}{}\doxyparagraph{Variable boundary file}\label{Manual_autotoc_md115}
...
There is no restriction in the number of columns. These values from each column will be forced uniformly spaced on the boundary and forcing in between will be linearly interpolated.\hypertarget{Manual_autotoc_md116}{}\doxysubsection{Bottom friction}\label{Manual_autotoc_md116}
...
\item 0 Quadratic
\item 1 Smart
\item -\/1 Mannings Quadratic friction is the default, with a uniform friction coefficient\+: 
\begin{DoxyCode}{0}
...
\end{DoxyItemize}\hypertarget{Manual_autotoc_md124}{}\doxysubsubsection{Map outputs}\label{Manual_autotoc_md124}
...
By default, the variables outputs are the one listed in the following paragraph\+: Default snapshot outputs. \hypertarget{Manual_autotoc_md125}{}\doxyparagraph{Default snapshot outputs}\label{Manual_autotoc_md125}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{Manual_autotoc_md126}{}\doxyparagraph{Complementary variables}\label{Manual_autotoc_md126}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Parameter   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Definition   }&\PBS\raggedleft \cellcolor{\tableheadbgcolor}\textbf{ Unit    }\\\cline{1-3}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md127}{}\doxyparagraph{Mean/averaged output between output steps}\label{Manual_autotoc_md127}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md128}{}\doxyparagraph{Max output}\label{Manual_autotoc_md128}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md129}{}\doxyparagraph{Risk assesment related output}\label{Manual_autotoc_md129}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md130}{}\doxyparagraph{Model related outputs}\label{Manual_autotoc_md130}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md131}{}\doxyparagraph{Other gradients and intermediate terms of the equations}\label{Manual_autotoc_md131}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md132}{}\doxysubsubsection{Point or Time-\/\+Serie output}\label{Manual_autotoc_md132}
...
\end{DoxyCode}
 The file contains 5 colums $(t, zs, h, u,v)$ with the value at the nearest grid point (to the position defined by the user).\hypertarget{Manual_autotoc_md133}{}\doxysubsection{Adaptative grid}\label{Manual_autotoc_md133}
