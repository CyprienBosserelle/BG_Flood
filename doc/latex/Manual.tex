...
\end{DoxyCode}
\hypertarget{Manual_autotoc_md114}{}\doxysubsubsection{Boundary file (for type 2 or 3)}\label{Manual_autotoc_md114}
Water level boundary file are needed to type 2 and 3 boundaries. The files are 2 (or more) columns, one with time in the first column and water level is the other(s). Note that the time step in the file doesn\textquotesingle{}t need to be constant. The model will linearly interpolated between steps in the file. The file can be either comma separated or tab separated. This is automatically detected.\hypertarget{Manual_autotoc_md115}{}\doxyparagraph{Uniform boundary file}\label{Manual_autotoc_md115}
...
\end{DoxyCode}
\hypertarget{Manual_autotoc_md116}{}\doxyparagraph{Variable boundary file}\label{Manual_autotoc_md116}
...
There is no restriction in the number of columns. These values from each column will be forced uniformly spaced on the boundary and forcing in between will be linearly interpolated.\hypertarget{Manual_autotoc_md117}{}\doxysubsection{Bottom friction}\label{Manual_autotoc_md117}
...
\end{DoxyItemize}\hypertarget{Manual_autotoc_md125}{}\doxysubsubsection{Map outputs}\label{Manual_autotoc_md125}
...
By default, the variables outputs are the one listed in the following paragraph\+: Default snapshot outputs. \hypertarget{Manual_autotoc_md126}{}\doxyparagraph{Default snapshot outputs}\label{Manual_autotoc_md126}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{Manual_autotoc_md127}{}\doxyparagraph{Complementary variables}\label{Manual_autotoc_md127}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{3}{|X[-1]}|}
\hline
\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Parameter   }&\PBS\centering \cellcolor{\tableheadbgcolor}\textbf{ Definition   }&\PBS\raggedleft \cellcolor{\tableheadbgcolor}\textbf{ Unit    }\\\cline{1-3}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md128}{}\doxyparagraph{Mean/averaged output between output steps}\label{Manual_autotoc_md128}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md129}{}\doxyparagraph{Max output}\label{Manual_autotoc_md129}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md130}{}\doxyparagraph{Risk assesment related output}\label{Manual_autotoc_md130}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md131}{}\doxyparagraph{Model related outputs}\label{Manual_autotoc_md131}
...
\end{longtabu}
\hypertarget{Manual_autotoc_md132}{}\doxyparagraph{Other gradients and intermediate terms of the equations}\label{Manual_autotoc_md132}
...
Fqux / Fqvx   &\PBS\centering XXXXXXXXXXXX   &\PBS\raggedleft \mbox{[}m2/s2\mbox{]}    \\\cline{1-3}
Su / Sv   &\PBS\centering XXXXXXXXXXXX   &\PBS\raggedleft \mbox{[}m2/s2\mbox{]}    \\\cline{1-3}
...
\char`\"{}vort\char`\"{},\char`\"{}dzsdx\char`\"{},\char`\"{}dzsdy\char`\"{},\char`\"{}dudx\char`\"{},\char`\"{}dudy\char`\"{},\char`\"{}dvdx\char`\"{},\char`\"{}dvdy\char`\"{},\char`\"{}\+Fhu\char`\"{},\char`\"{}\+Fhv\char`\"{},\char`\"{}\+Fqux\char`\"{},\char`\"{}\+Fqvy\char`\"{},\char`\"{}\+Fquy\char`\"{},\char`\"{}\+Fqvx\char`\"{},\char`\"{}\+Su\char`\"{},\char`\"{}\+Sv\char`\"{},\char`\"{}dh\char`\"{},\char`\"{}dhu\char`\"{},\char`\"{}dhv\char`\"{},\char`\"{}cf\char`\"{}\hypertarget{Manual_autotoc_md133}{}\doxysubsubsection{Point or Time-\/\+Serie output}\label{Manual_autotoc_md133}
...
\end{DoxyCode}
 The file contains 5 colums $(t, zs, h, u,v)$ with the value at the nearest grid point (to the position defined by the user).\hypertarget{Manual_autotoc_md134}{}\doxysubsection{Adaptative grid}\label{Manual_autotoc_md134}
