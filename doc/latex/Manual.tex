...
\Hypertarget{Manual_md_doc_Manual}%
 {\itshape This file is not uptodate with the last version of the Code\+: Please, use the Parameters and Forcings list as a reference}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{Manual_autotoc_md104}{}\doxysection{Input Parameters \{\#ref input-\/parameters\}}\label{Manual_autotoc_md104}
\hypertarget{Manual_autotoc_md105}{}\doxysubsection{BG\+\_\+param.\+txt}\label{Manual_autotoc_md105}
All the model inputs are controlled by the BG\+\_\+param.\+txt file. It is a simple text file that contains the parameters of the model that the user wishes to change.\hypertarget{Manual_autotoc_md106}{}\doxysubsubsection{How to use the BG\+\_\+param.\+txt file}\label{Manual_autotoc_md106}
