...
Using multi-\/resolution in BG\+\_\+\+Flood, we need to keep track of how blocks with different resolutions talk to each other. This page tries to explain how this is done.\hypertarget{HaloGradient_autotoc_md74}{}\doxysubsubsection{Why halo}\label{HaloGradient_autotoc_md74}
...
\end{DoxyInlineImage}
\hypertarget{HaloGradient_autotoc_md75}{}\doxysubsubsection{Restriction and prolongation}\label{HaloGradient_autotoc_md75}
...
\end{DoxyInlineImage}
\hypertarget{HaloGradient_autotoc_md76}{}\doxyparagraph{Prolongation}\label{HaloGradient_autotoc_md76}
...
\$\$\+HaloB = A + Gradient(\+A) $\ast$ dx $\ast$ 0.\+5\$\$\hypertarget{HaloGradient_autotoc_md77}{}\doxyparagraph{Restriction}\label{HaloGradient_autotoc_md77}
Restriction is where we calculate the value of a coarse cell from values of fine cells. This is usually done with cell average. \$\$\+HaloA = 0.\+25$\ast$(B1+\+B2+\+B3+\+B4)\$\$\hypertarget{HaloGradient_autotoc_md78}{}\doxysubsubsection{Filling the Halo\+: The chicken and the egg.}\label{HaloGradient_autotoc_md78}
...
{\itshape Initial loss and continuing loss reprensentation during a cell-\/wetting event}\hypertarget{ILCL_autotoc_md83}{}\doxyparagraph{$<$strong$>$\+Important notes$<$/strong$>$\+:}\label{ILCL_autotoc_md83}
...
\end{DoxyCode}
 \hypertarget{ILCL_autotoc_md84}{}\doxysubsubsection{Testcase for the ILCL model}\label{ILCL_autotoc_md84}
...
\end{DoxyInlineImage}
\hypertarget{ILCL_autotoc_md85}{}\doxysubsubsection{Reference values}\label{ILCL_autotoc_md85}
...
\end{longtabu}
\hypertarget{WetdryfixConservelevation_autotoc_md87}{}\doxysubsubsection{Tsumani test results}\label{WetdryfixConservelevation_autotoc_md87}
The impact of the wet/dry fix should be much more obvious in tsunami simulation but here conserve elevation should be used in most tsunami cases.\hypertarget{WetdryfixConservelevation_autotoc_md88}{}\doxyparagraph{No wetdryfix}\label{WetdryfixConservelevation_autotoc_md88}
...
\hypertarget{WetdryfixConservelevation_autotoc_md89}{}\doxyparagraph{Wetdryfix}\label{WetdryfixConservelevation_autotoc_md89}
When using the wetdryfix the instabilities disappear and the solution is smoother.

\hypertarget{WetdryfixConservelevation_autotoc_md90}{}\doxyparagraph{Comparison Wetdryfix vs no Wetdryfix}\label{WetdryfixConservelevation_autotoc_md90}
...
\hypertarget{WetdryfixConservelevation_autotoc_md91}{}\doxyparagraph{Conserve Elevation}\label{WetdryfixConservelevation_autotoc_md91}
