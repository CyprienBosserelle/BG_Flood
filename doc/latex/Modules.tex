...
{\itshape Initial loss and continuing loss reprensentation during a cell-\/wetting event}\hypertarget{ILCL_autotoc_md82}{}\doxyparagraph{$<$strong$>$\+Important notes$<$/strong$>$\+:}\label{ILCL_autotoc_md82}
...
\end{DoxyCode}
 \hypertarget{ILCL_autotoc_md83}{}\doxysubsubsection{Testcase for the ILCL model}\label{ILCL_autotoc_md83}
...
\end{DoxyInlineImage}
\hypertarget{ILCL_autotoc_md84}{}\doxysubsubsection{Reference values}\label{ILCL_autotoc_md84}
...
\end{longtabu}
\hypertarget{WetdryfixConservelevation_autotoc_md86}{}\doxysubsubsection{Tsumani test results}\label{WetdryfixConservelevation_autotoc_md86}
The impact of the wet/dry fix should be much more obvious in tsunami simulation but here conserve elevation should be used in most tsunami cases.\hypertarget{WetdryfixConservelevation_autotoc_md87}{}\doxyparagraph{No wetdryfix}\label{WetdryfixConservelevation_autotoc_md87}
...
\hypertarget{WetdryfixConservelevation_autotoc_md88}{}\doxyparagraph{Wetdryfix}\label{WetdryfixConservelevation_autotoc_md88}
When using the wetdryfix the instabilities disappear and the solution is smoother.

\hypertarget{WetdryfixConservelevation_autotoc_md89}{}\doxyparagraph{Comparison Wetdryfix vs no Wetdryfix}\label{WetdryfixConservelevation_autotoc_md89}
...
\hypertarget{WetdryfixConservelevation_autotoc_md90}{}\doxyparagraph{Conserve Elevation}\label{WetdryfixConservelevation_autotoc_md90}
