...
Make sure you have latest CUDA Toolkit, g++ and Net\+CDF libraries installed.
...
The code is actually running on \href{https://www.nesi.org.nz}{\texttt{ New Zealand e\+Science Infrastructure (Ne\+SI)}}.\hypertarget{Use-On-SuperComputer_autotoc_md102}{}\doxysubsubsection{Compiling the code}\label{Use-On-SuperComputer_autotoc_md102}
...
\end{DoxyItemize}\hypertarget{Use-On-SuperComputer_autotoc_md103}{}\doxysubsubsection{Running the code}\label{Use-On-SuperComputer_autotoc_md103}
