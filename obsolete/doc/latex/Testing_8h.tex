...
\item 
{\footnotesize template$<$class T $>$ }\\bool \mbox{\hyperlink{Testing_8h_a31b092b81a7e3ff99df93441e5d0bb62}{Raintest}} (T zsnit, int gpu, float alpha, int engine)
\item 
...
\item 
{\footnotesize template$<$class T $>$ }\\bool \mbox{\hyperlink{Testing_8h_aee83c778b6d86fde8c183b3a896cdc71}{Test\+Multi\+Bathy\+Rough}} (int gpu, T ref, int secnario)
\item 
{\footnotesize template$<$class T $>$ }\\bool \mbox{\hyperlink{Testing_8h_ad474adad94a69be09516b5f538fc460a}{Test\+Flexible\+Output\+Times}} (int gpu, T ref, int scenario)
...
{\footnotesize\ttfamily template$<$class T $>$ \\
bool Raintest (\begin{DoxyParamCaption}\item[{T}]{zsnit,  }\item[{int}]{gpu,  }\item[{float}]{alpha,  }\item[{int}]{engine }\end{DoxyParamCaption})}
...
\mbox{\Hypertarget{Testing_8h_ad474adad94a69be09516b5f538fc460a}\label{Testing_8h_ad474adad94a69be09516b5f538fc460a}} 
\index{Testing.h@{Testing.h}!TestFlexibleOutputTimes@{TestFlexibleOutputTimes}}
\index{TestFlexibleOutputTimes@{TestFlexibleOutputTimes}!Testing.h@{Testing.h}}
...
OUTDATED? \mbox{\Hypertarget{Testing_8h_aee83c778b6d86fde8c183b3a896cdc71}\label{Testing_8h_aee83c778b6d86fde8c183b3a896cdc71}} 
\index{Testing.h@{Testing.h}!TestMultiBathyRough@{TestMultiBathyRough}}
\index{TestMultiBathyRough@{TestMultiBathyRough}!Testing.h@{Testing.h}}
\doxysubsubsection{\texorpdfstring{TestMultiBathyRough()}{TestMultiBathyRough()}}
{\footnotesize\ttfamily template$<$class T $>$ \\
bool Test\+Multi\+Bathy\+Rough (\begin{DoxyParamCaption}\item[{int}]{gpu,  }\item[{T}]{ref,  }\item[{int}]{secnario }\end{DoxyParamCaption})}

\mbox{\Hypertarget{Testing_8h_a0755c7670bec1082029464abce5504ad}\label{Testing_8h_a0755c7670bec1082029464abce5504ad}} 
