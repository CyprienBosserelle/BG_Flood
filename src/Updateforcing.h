...
template <class T> __host__ void AddrainforcingCPU(Param XParam, BlockP<T> XBlock, DynForcingP<float> Rain, AdvanceP<T> XAdv, int nblk_local_start = 0); // Assuming this was missed earlier
