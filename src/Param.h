...
public:
	...
	double theta_imp = 0.55; // theta for the implicit barotropic solver (Default: 0.55 for unconditional stability)
	int mg_max_iter = 30; // Maximum number of iterations for the implicit solver (Default: 30)
