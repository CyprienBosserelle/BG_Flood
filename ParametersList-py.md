...
|outfile|outfile| -1|Maximum initial time steps in s (should be positive, advice 0.1 if dry domain initialement) |
...
|vtk_outputfile_root|vtk_outputfile_root| 1.0|XXX  for ParaView Catalyst|
|python_pipeline|python_pipeline| 1.0|XXX  for ParaView Catalyst|
...
|Atmp| Atmp , atmpfile |None|Atmp='AtmosphericPressure.nc'| Atmospheric forcing (XXXXXX)|
