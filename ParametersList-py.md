...
|dt|dt|init = -1|Maximum initial time steps in s (should be positive, advice 0.1 if dry domain initialement) |
...
|TSnodesout| TSnodesout , TSOutput |None<br>|vector containing i and j of each variables<br>Example: "TSnodesout: TOOOTOTOTOOOOT"<br>|
...
|g|g|rdalpha= nan("")|Grid rotation Y axis from the North input in degrees but later converted to rad|
