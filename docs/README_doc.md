...
- mkdoxy plugin is added convert XML files generated by doxygen in markdown and include them in the documentation.
...
The documentation is then deployed directly from the github page of the code, using a workflow action. When this action is triggered, the documentation pages are updated and pushed in a special branch: "gh-page" and deployed from there.

Different plugins have been added to improve the documentation:
