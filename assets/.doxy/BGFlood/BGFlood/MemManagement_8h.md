...
|  void | [**AllocateCPU**](#function-allocatecpu) (int nx, int ny, T \*& zs, T \*& h, T \*& u, T \*& v, T \*& U, T \*& hU, T \*& hUU) <br>_Allocate memory for extended arrays (zs, h, u, v, U, hU) on the CPU._  |
|  void | [**AllocateCPU**](#function-allocatecpu) (int nx, int ny, [**GradientsP**](structGradientsP.md)&lt; T &gt; & Grad) <br>_Allocate memory for gradient arrays on the CPU._  |
...
|  int | [**memloc**](#function-memloc) ([**Param**](classParam.md) XParam, int i, int j, int ib) <br>_Compute memory index for a cell in a block (using_ [_**Param**_](classParam.md) _)._ |
