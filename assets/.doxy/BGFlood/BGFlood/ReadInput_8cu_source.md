...
[**File List**](files.md) **>** [**src**](dir_68267d1309a1af8e8297ef4c3efbcdba.md) **>** [**ReadInput.cu**](ReadInput_8cu.md)

[Go to the documentation of this file](ReadInput_8cu.md)
...
Param readparamstr(std::string line, Param param)
{
    ...
    if (!parametervalue.empty())
    {
        ...
        for (int nv = 0; nv < vars.size(); nv++)
        {
            ...
            param.outmean = (vvar.compare("hUUmean") == 0) ? true : param.outmean;
            ...
            param.outmax = (vvar.compare("hUUmax") == 0) ? true : param.outmax;
