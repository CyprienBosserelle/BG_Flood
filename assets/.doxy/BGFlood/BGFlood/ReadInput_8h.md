...
| Type | Name |
| ---: | :--- |
|  void | [**InitialiseToutput**](#function-initialisetoutput) ([**T\_output**](classT__output.md) & Toutput, [**Param**](classParam.md) XParam) <br>_Initialise the Toutput structure with output times. This function reads the output times from a specified input string and ensures that the times are within the simulation time range. If no valid times are provided, it defaults to using the total time and end time._  |
